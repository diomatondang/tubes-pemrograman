...
<body>
       ...
       <div class="col-md-6 right-box">
          <div class="row align-items-center">
                <div class="header-text mb-4">
                     <h2>Login User</h2>
                     <p>Input Username dan Password</p>
                </div>
                <div class="input-group mb-3">
                    <input type="text" class="form-control form-control-lg bg-light fs-6" placeholder="Input username">
                </div>
                <div class="input-group mb-1">
                    <input type="password" class="form-control form-control-lg bg-light fs-6" id="tekan" placeholder="Input Password">
                </div>
                <div class="input-group mb-5 d-flex justify-content-between">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="" onclick="myFunction()">
                        <label for="formCheck" class="form-check-label text-secondary"><small>Lihat Password</small></label>
                    </div>
                    <div class="forgot">
	...
	<script>
	function myFunction() {
		var x = document.getElementById("tekan");
		if (x.type === "password") {
			x.type = "text";
		} else {
			x.type = "password";
